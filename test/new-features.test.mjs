...
const blocks = Array.from({length:6},(_,i)=>`${i+1}번째 문장은 기사에서 확인된 사실만 차분하게 전달하며 독자가 맥락을 이해하도록 구체적인 설명을 충분히 덧붙이고 확인되지 않은 반응이나 추측을 섞지 않으면서 서로 다른 보도의 공통점과 차이를 신중하게 정리합니다.`);
