...
export const VALIDATOR_PROMPT = "기사와 Fact에 없는 인물·사건·반응, 과장하거나 자극적인 제목, 비난·단정, 원문 과도 복제, 소제목 사용, 정확히 7 blocks, 각 block 90자 이상, 중복 없는 10 tags, 본문 공백 포함 600~800자를 엄격히 검사하라. 문장별 글자 수와 전체 글자 수 조건을 반드시 지켜야 한다.";
export { schemas };
